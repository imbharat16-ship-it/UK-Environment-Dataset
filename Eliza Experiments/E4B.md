# Eliza · Run 4 Benchmark (Selective Lenses)

**Run 4** · Selective lenses (2 per question) + tone  
**Evidence:** `E-Data.md` · **Lenses:** `E-Lenses.md` (2 per question)  
**Actual:** `Cohort-based questions.md` (Interview 2, held-out)  
**Judge:** `Simulate_judge` ([KikiLabs Prompts.md](../KikiLabs Prompts.md)) · post P0 re-judge (Jul 2026)

Predicted text unchanged; scores and rationales reflect the updated rubric (WRONG MAIN REASON, examples rule, main stance not keywords). See also `E8B.md` for Run 8 re-score audit trail.
...
| # | Question | Score | Δ |
|---|----------|------:|--:|
| 1 | How do alternative packaging materials c… | **86** | +7 |
| 2 | What are your views on the environmental… | **65** | +13 |
| 3 | How confident are you that you know the … | **88** | +4 |
| 4 | How does food waste or freshness affect … | **96** | +4 |
| 5 | Does packaging influence what you buy? | **44** | 0 |
| **Mean** | | **75.8** | **+5.6** |
| **Mean (excl. Q5)** | | **83.8** | **+7.0** |

| Metric | Selective | Raw+Tone |
|--------|----------:|---------:|
| Mean | **75.8** | 67.8 |
| Mean (excl. Q5) | **83.8** | 73.8 |
...
**matchRationale:** OPEN-ENDED · WRONG MAIN REASON (partial). Prediction includes actual's key thread ("see more things in paper now, which is good") and closes with the same "I don't know what to say," but still centres budget/tension more than actual's brief industry-shift gladness. WRONG MAIN REASON cap applies but partial alignment is stronger than first-pass score → 65.
